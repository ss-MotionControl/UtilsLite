...
public:
  ...
  exact_solution( vector<Vector> & x_vec ) const override {
    ...
    x1.resize(n);
    x2.resize(n);
    x0 << 61.15373203411778822477588185225287963418,
          6.976291974526651896957787060226279608637;
    x1 << 67.09266776655127299522316830183801702230,
          7.614805557040459414336978005675721174002;
    x2 << -33.28012846942180982310942345376518595181,
          28.52767665376609064013743556335143862501;
  }
