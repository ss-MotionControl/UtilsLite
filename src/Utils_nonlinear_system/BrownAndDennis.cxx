...
public:
  ...
  exact_solution( vector<Vector> & x_vec ) const override {
    ...
    auto & x0{ x_vec[0] };
    x0.resize(n);
    x0 << -11.59443990476216538261421860886232167047,
           13.20363005120720382131746247754292259854,
          -0.4034394881768595196441977938137369661485,
           0.2367787744557362991471155778176237456915;
  }
