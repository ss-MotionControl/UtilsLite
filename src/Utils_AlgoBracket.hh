...
//! \brief Abstract base class for defining mathematical functions used in the Bracket search
//! algorithm.
//!
...
//! Users must inherit from this class and implement the virtual method to define their specific
//! functions.
//!
//! **Template Parameter:**
...
//!        Optimality*, ACM Transactions on Mathematical Software, vol 47, N.1, 2020
//!
...
//!    real_type root = solver.eval2(a, b, std::bind(myParameterizedFunction, std::placeholders::_1,
//!    parameter));
//!
//!    // Print the results
//!    cout << "Root found: " << root << endl;
