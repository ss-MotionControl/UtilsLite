...
namespace Utils
{
  ...
  */
  ...
  //!    real_type root = solver.eval2(a, b, [](real_type x) { return sin(x) - x
  //!    / 2; });
  //!
  //!    // Print the results
  //!    cout << "Root found: " << root << endl;
  ...
  //!    real_type root = solver.eval2(a, b, std::bind(myParameterizedFunction,
  //!    std::placeholders::_1, parameter));
  //!
  //!    // Print the results
  //!    cout << "Root found: " << root << endl;
  //!    cout << "f(root) = " << myParameterizedFunction(root, parameter) <<
  //!    endl;
  //!
  //!    return 0;
  //!  }
  ...
  public:
    ...
    //! `Bracket_base_fun<Real>` starting from guess interval `[a,b]`
    //!
    //! \param a    lower bound search interval
    //! \param b    upper bound search interval
    //! \param fun  the pointer to base class `Bracket_base_fun<Real>` wrapping
    //! the user function
    //!
    Real
    ...
    void
    select( unsigned i_algo )
    {
      switch ( i_algo )
      {
        case 0:
          m_select = Method::BISECTION;
          break;
        case 1:
          m_select = Method::ILLINOIS;
          break;
        case 2:
          m_select = Method::CHANDRUPATLA;
          break;
        case 3:
          m_select = Method::BRENT;
          break;
        case 4:
          m_select = Method::RIDDER;
          break;
        case 5:
          m_select = Method::MODIFIED_AB;
          break;
        case 6:
          m_select = Method::ALGO748;
          break;
      }
    }
  };
