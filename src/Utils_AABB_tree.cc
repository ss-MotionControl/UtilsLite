...
namespace Utils
{
  ...
  {
    return pnt[0] <= bbox2[3] && pnt[0] >= bbox2[0] && pnt[1] <= bbox2[4] && pnt[1] >= bbox2[1] && pnt[2] <= bbox2[5] &&
           pnt[2] >= bbox2[2];
  }
  ...
  {
    return pnt[0] <= bbox2[4] && pnt[0] >= bbox2[0] && pnt[1] <= bbox2[5] && pnt[1] >= bbox2[1] && pnt[2] <= bbox2[6] &&
           pnt[2] >= bbox2[2] && pnt[3] <= bbox2[7] && pnt[3] >= bbox2[3];
  }
  ...
  {
    return pnt[0] <= bbox2[5] && pnt[0] >= bbox2[0] && pnt[1] <= bbox2[6] && pnt[1] >= bbox2[1] && pnt[2] <= bbox2[7] &&
           pnt[2] >= bbox2[2] && pnt[3] <= bbox2[8] && pnt[3] >= bbox2[3] && pnt[4] <= bbox2[9] && pnt[4] >= bbox2[4];
  }
  ...
  {
    return pnt[0] <= bbox2[6] && pnt[0] >= bbox2[0] && pnt[1] <= bbox2[7] && pnt[1] >= bbox2[1] && pnt[2] <= bbox2[8] &&
           pnt[2] >= bbox2[2] && pnt[3] <= bbox2[9] && pnt[3] >= bbox2[3] && pnt[4] <= bbox2[10] &&
           pnt[4] >= bbox2[4] && pnt[5] <= bbox2[11] && pnt[5] >= bbox2[5];
  }
  ...
  {
    return pnt[0] <= bbox2[7] && pnt[0] >= bbox2[0] && pnt[1] <= bbox2[8] && pnt[1] >= bbox2[1] && pnt[2] <= bbox2[9] &&
           pnt[2] >= bbox2[2] && pnt[3] <= bbox2[10] && pnt[3] >= bbox2[3] && pnt[4] <= bbox2[11] &&
           pnt[4] >= bbox2[4] && pnt[5] <= bbox2[12] && pnt[5] >= bbox2[5] && pnt[6] <= bbox2[13] && pnt[6] >= bbox2[6];
  }
  ...
  AABBtree<Real>::check_overlap( Real const bb1[], Real const bb2[], integer dim )
  {
    ...
    switch ( k )
    {
      case 1:
        ...
        break;
      case 2:
        overlap = bb1[0] <= bb2[dim + 0] && bb1[dim + 0] >= bb2[0] && bb1[1] <= bb2[dim + 1] && bb1[dim + 1] >= bb2[1];
        break;
      case 3:
    ...
    {
      overlap = bb1[0] <= bb2[dim + 0] && bb1[dim + 0] >= bb2[0] && bb1[1] <= bb2[dim + 1] && bb1[dim + 1] >= bb2[1] &&
                bb1[2] <= bb2[dim + 2] && bb1[dim + 2] >= bb2[2] && bb1[3] <= bb2[dim + 3] && bb1[dim + 3] >= bb2[3];
      bb1 += 4;
      bb2 += 4;
    }
    return overlap;
  ...
  template <typename Real>
  void
  AABBtree<Real>::intersect_with_one_point( Real const pnt[], AABB_SET & bb_index ) const
  {
    m_num_check = 0;
  ...
  template <typename Real>
  void
  AABBtree<Real>::intersect_with_one_point_and_refine( Real const pnt[], AABB_SET & bb_index ) const
  {
    m_num_check = 0;
  ...
  template <typename Real>
  void
  AABBtree<Real>::intersect_with_one_bbox( Real const bbox[], AABB_SET & bb_index ) const
  {
    m_num_check = 0;
  ...
  template <typename Real>
  void
  AABBtree<Real>::intersect_with_one_bbox_and_refine( Real const bbox[], AABB_SET & bb_index ) const
  {
    m_num_check = 0;
  ...
  template <typename Real>
  void
  AABBtree<Real>::intersect( AABBtree const & aabb, AABB_MAP & bb_index ) const
  {
    m_num_check = 0;
  ...
  template <typename Real>
  void
  AABBtree<Real>::intersect_and_refine( AABBtree const & aabb, AABB_MAP & bb_index ) const
  {
    m_num_check = 0;
  ...
  template <typename Real>
  void
  AABBtree<Real>::pnt_bbox_minmax( Real const pnt[], Real const bbox[], Real & dmin2, Real & dmax2 ) const
  {
  ...
  template <typename Real>
  void
  AABBtree<Real>::min_distance_candidates( Real const pnt[], AABB_SET & bb_index ) const
  {
