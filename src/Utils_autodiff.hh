...
#define UTILS_AUTODIFF_DERIV_5ARG( INLINE, CLASS, PREFIX, FUN, CONST )                                                \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_1( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 )   \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad;                                                                                                  \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_2( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 )   \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad;                                                                                                  \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_3( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 )   \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad;                                                                                                  \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_4( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 )   \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad;                                                                                                  \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_5( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 )   \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad;                                                                                                  \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_1_1( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_1_2( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_1_3( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_1_4( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_1_5( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_2_2( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_2_3( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_2_4( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_2_5( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_3_3( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_3_4( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_3_5( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_4_4( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_4_5( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
    ...
    return res.grad.grad;                                                                                             \
                                                                                                                      ...
                                                                                                                      \
  INLINE real_type CLASS                                                                                              \
  PREFIX##D_5_5( real_type const x1, real_type const x2, real_type const x3, real_type const x4, real_type const x5 ) \
    CONST                                                                                                             \
  {                                                                                                                   \
...
#define UTILS_AUTODIFF_DERIV_6ARG( INLINE, CLASS, PREFIX, FUN, CONST ) \
  INLINE real_type CLASS PREFIX##D_1(                                  \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad;                                                   \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_2(                                  \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad;                                                   \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_3(                                  \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad;                                                   \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_4(                                  \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad;                                                   \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_5(                                  \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad;                                                   \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_6(                                  \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad;                                                   \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_1_1(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_1_2(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_1_3(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_1_4(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_1_5(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_1_6(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_2_2(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_2_3(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_2_4(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_2_5(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_2_6(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_3_3(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_3_4(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_3_5(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_3_6(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_4_4(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_4_5(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_4_6(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_5_5(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_5_6(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
  ...
  {                                                                    \
    ...
    return res.grad.grad;                                              \
                                                                       ...
                                                                       \
  INLINE real_type CLASS PREFIX##D_6_6(                                \
    real_type const x1,                                                \
    real_type const x2,                                                \
    real_type const x3,                                                \
    real_type const x4,                                                \
...
#define UTILS_AUTODIFF_DERIV_5ARG_DEF( PREFIX, CONST ) \
  real_type PREFIX##D_1(                               \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_2(                               \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_3(                               \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_4(                               \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_5(                               \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_1_1(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_1_2(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_1_3(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_1_4(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_1_5(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_2_2(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_2_3(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_2_4(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_2_5(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_3_3(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_3_4(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_3_5(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_4_4(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_4_5(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
    real_type const x5 ) CONST;                        \
  real_type PREFIX##D_5_5(                             \
    real_type const x1,                                \
    real_type const x2,                                \
    real_type const x3,                                \
    real_type const x4,                                \
