...
dual f4(dual x, const Params& params)
{
...
main() {
...

  {
    ...
    auto fun = []( dual x, dual y) -> dual {
      return hypot( x, x+y, x-y ) * x * y;
    };
...

  {
    ...
    auto fun = []( dual2nd x, dual2nd y) -> dual2nd {
      return hypot( x, x+y, x-y ) * x * y;
    };
...

  {
    ...
    auto fun = []( dual2nd x, dual2nd y) -> dual2nd {
      return log( 1 + x + y*y ) - log1p( x + y*y );
    };
